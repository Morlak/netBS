...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 14 Août 2014 à 23:04
...
(2, 'chemin des planches 1', 1073, 'savigny', 1, 'zboub yolo'),
...
(3, 1, 6, 6, '2014-07-15', NULL, NULL, NULL, '2014-07-22', 'Christian wowow', 'homme');
...
(2, 8, 2, 1, '2014-06-11', '2199-01-01'),
(3, 3, 1, 2, '2012-01-14', '2199-01-01');
...
CREATE TABLE IF NOT EXISTS `structure_distinctions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `obtentionDistinctions` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:object)',
...
INSERT INTO `structure_distinctions` (`id`, `nom`, `obtentionDistinctions`, `remarques`) VALUES
(1, '1ère classe', 'N;', 'A réussi l''examen du première classe'),
(2, '2ème classe', 'N;', 'Progression 2 ème branche');
...
CREATE TABLE IF NOT EXISTS `structure_obtention_distinctions` (
  ...
  `distinction` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:object)',
  PRIMARY KEY (`id`),
...
INSERT INTO `structure_obtention_distinctions` (`id`, `membre_id`, `obtention`, `distinction`) VALUES
(1, 1, '2000-06-20', 'O:42:"Interne\\StructureBundle\\Entity\\Distinction":4:{s:46:"\0Interne\\StructureBundle\\Entity\\Distinction\0id";i:1;s:47:"\0Interne\\StructureBundle\\Entity\\Distinction\0nom";s:12:"1ère classe";s:65:"\0Interne\\StructureBundle\\Entity\\Distinction\0obtentionDistinctions";N;s:53:"\0Interne\\StructureBundle\\Entity\\Distinction\0remarques";s:38:"A réussi l''examen du première classe";}'),
(2, 1, '2014-06-23', 'O:42:"Interne\\StructureBundle\\Entity\\Distinction":4:{s:46:"\0Interne\\StructureBundle\\Entity\\Distinction\0id";i:1;s:47:"\0Interne\\StructureBundle\\Entity\\Distinction\0nom";s:12:"1ère classe";s:65:"\0Interne\\StructureBundle\\Entity\\Distinction\0obtentionDistinctions";N;s:53:"\0Interne\\StructureBundle\\Entity\\Distinction\0remarques";s:38:"A réussi l''examen du première classe";}');
